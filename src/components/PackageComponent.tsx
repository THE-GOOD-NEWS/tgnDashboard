...
const PackageComponent = ({
  ...
  return (
    <div className="relative min-h-2 w-[97%] rounded-2xl bg-backgroundColor/25 bg-secondary px-2 py-1 text-creamey">
      <div className="mr-28 flex w-full items-start text-primary hover:cursor-pointer">
        <div className="flex w-full items-start justify-between pb-2 text-creamey">
          ...
          <div className="flex flex-col">
            ...
            <p
              className={`${headerFont.className} text-sm text-creamey/90 xl:text-base`}
            >
            ...
            <div className="flex items-center gap-2">
              {packageItem.images && packageItem.images.length > 0 && (
                <div className="flex items-center">
                  <FaImages className="mr-1 text-creamey/90" />
                  <span
                    className={`${headerFont.className} text-xs text-creamey/90 xl:text-sm`}
                  >
              ...
              {packageItem.cards && packageItem.cards.length > 0 && (
                <div className="ml-2 flex items-center">
                  <IoCardOutline className="mr-1 text-creamey/90" />
                  <span
                    className={`${headerFont.className} text-xs text-creamey/90 xl:text-sm`}
                  >
          ...
          <div className="flex flex-col items-end">
            <p className={`${headerFont.className} text-xl xl:text-2xl`}>
            ...
            <div className="relative">
              ...
              {optionsModalIsOpen && (
                <div
                  ref={modalRef}
                  className="absolute right-0 top-full z-50 mt-2 w-48 rounded-md border bg-creamey shadow-lg"
                >
                  <div className="py-1">
                    <button
                      onClick={(e) => {
                      ...
                      className="block w-full px-4 py-2 text-left text-sm text-primary/90 hover:underline"
                    >
                      View Details
                    </button>
                    <button
