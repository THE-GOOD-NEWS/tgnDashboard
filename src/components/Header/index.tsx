...
const Header = (props: {
  ...
  return (
    <header className="sticky  top-0 z-999 flex w-full bg-primary drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 lg:hidden 2xl:px-11">
        <div className="flex w-full items-center justify-between gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke p-1.5 text-white shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
